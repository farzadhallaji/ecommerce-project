	...
	public function addOrderHistory($order_id, $order_status_id, $comment = '', $notify = false, $override = false) {
		...
		if ($order_info) {
			...
			if (!$order_info['order_status_id'] && $order_status_id) {
				...
				$data['date_added'] = $language->get('code') == 'fa' ? jdate($this->config->get('config_shamsidate_format'), strtotime($order_info['date_added'])) : date($language->get('date_format_short'), strtotime($order_info['date_added']));
				...
				$text .= $language->get('text_new_date_added') . ' ' . $language->get('code') == 'fa' ? jdate($this->config->get('config_shamsidate_format'), strtotime($order_info['date_added'])) : date($language->get('date_format_short'), strtotime($order_info['date_added'])) . "\n";
			...
			if ($order_info['order_status_id'] && $order_status_id && $notify) {
				...
				$message .= $language->get('text_update_date_added') . ' ' . $language->get('code') == 'fa' ? jdate($this->config->get('config_shamsidate_format'), strtotime($order_info['date_added'])) : date($language->get('date_format_short'), strtotime($order_info['date_added'])) . "\n\n";
