...
class ControllerReportSaleOrder extends Controller {
	public function index() {
		...
		foreach ($results as $result) {
			$data['orders'][] = array(
				'date_start' => ($this->language->get('code') == 'fa') ? jdate($this->config->get('config_shamsidate_format'), strtotime($result['date_start'])) : date($this->language->get('date_format_short'), strtotime($result['date_start'])),
				'date_end'   => ($this->language->get('code') == 'fa') ? jdate($this->config->get('config_shamsidate_format'), strtotime($result['date_end'])) : date($this->language->get('date_format_short'), strtotime($result['date_end'])),
